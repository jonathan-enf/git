...
'git rebase' [-i | --interactive] [<options>] [--exec <cmd>] [--onto <newbase>]
	--root [<branch>]
'git rebase' (--continue|--skip|--abort|--quit|--edit-todo|--show-current-patch|--status)
...
--status::
	Indicates if a rebase operation is currently in progress.
	Returns exit code 0 (true) if a rebase operation is currently
	in progress, or 1 (false) otherwise.
